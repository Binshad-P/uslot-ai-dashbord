...
import UserScoreTableRow from '../user-score-table-row';
import UserScoreTableToolbar from '../user-score-table-toolbar';
import UserScoreTableFiltersResult from '../user-score-table-filter-result';
...
const TABLE_HEAD = [
  ...
  { id: 'enterprising', label: 'Enterprising' },
  { id: 'conventional', label: 'Conventional' },
  { id: 'introvert_extrovert', label: 'Introvert  Extrovert' },
  { id: 'intuitive_sensing', label: 'Intuitive Sensing' },
  { id: 'thinking_feeling', label: 'Thinking Feeling' },
  { id: 'judging_prospecting', label: 'Judging Prospecting' },
...
export default function UserScoreListView() {
