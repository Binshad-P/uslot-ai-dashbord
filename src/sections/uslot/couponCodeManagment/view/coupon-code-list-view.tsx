...
import CouponCodeTableRow from '../coupon-code-table-row';
...
const TABLE_HEAD = [
  ...
  { id: 'expiry_date', label: 'Expiry Date', width: 180 },
  { id: 'test_count', label: 'Test Count', width: 220 },
  { id: 'commission_amount ', label: 'Commission Amount', width: 180 },
  { id: 'discounted_amount', label: 'Discounted Amount', width: 100 },
...
export default function CouponCodeListView() {
